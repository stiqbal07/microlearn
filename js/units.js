...
const SUBJECT_UNITS = {
  ...
  biology: [
    ...
    { id:'bio_u3', name:'Genetics & DNA',              icon:'🧬', topics:['Genetics','DNA & Proteins'] },
  ...
  english: [
    ...
    { id:'eng_u2', name:'Literary Analysis',           icon:'📖', topics:['Literary Analysis'] },
  ...
  spanish2: [
    ...
    { id:'esp_u4', name:'Pronouns & Reflexive Verbs',  icon:'🔤', topics:['Object Pronouns','Reflexive Verbs'] },
    { id:'esp_u5', name:'Vocabulary & Culture',        icon:'🌎', topics:['Vocabulary','Culture'] },
  ],
};
